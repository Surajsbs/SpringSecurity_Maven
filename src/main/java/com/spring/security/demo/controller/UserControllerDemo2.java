 ...
 */
@RestController
@RequestMapping(value = "/data2", produces = MediaType.APPLICATION_JSON_VALUE)
public class UserControllerDemo2 {
	...
	@PreAuthorize("(hasRole('ROLE_ADMIN') Or hasRole('ROLE_TEAM_LEADER') or hasRole('ROLE_BA') oR hasRole('ROLE_QE') OR hasRole('ROLE_DEVELOPER')) and hasPermission('hasAccess','VIEW')")
	...
	@PreAuthorize("(hasRole('ROLE_DEVELOPER') OR hasRole('ROLE_TEAM_LEADER') or hasRole('ROLE_QE')) and hasPermission('hasAccess','ASSIGN')")
	...
	@PreAuthorize("(hasRole('ROLE_DEVELOPER') OR hasRole('ROLE_TEAM_LEADER') OR hasRole('ROLE_BA')) and hasPermission('hasAccess','UPDATE')")
	...
	@PreAuthorize("hasRole('ROLE_ADMIN') and hasPermission('hasAccess','DELETE')")
	...
	@PreAuthorize("hasRole('ROLE_ADMIN') and hasPermission('hasAccess','REVOKE')")
	...
	@PreAuthorize("(hasRole('ROLE_TEAM_LEADER') OR hasRole('ROLE_BA') OR hasRole('ROLE_QE') OR hasRole('ROLE_DEVELOPER') OR hasRole('ROLE_ADMIN')) and hasPermission('hasAccess','CREATE')")
